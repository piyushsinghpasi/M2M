...
# Example input: List of models and corresponding JSON data
#models_data = [
#    {
#        "model_name": "Model_X",
#        "json_data": {
#            "eval/R@1/i2t/english_lang": 64.6,
#            "eval/R@5/i2t/english_lang": 87.4,
#            "eval/R@10/i2t/english_lang": 94.1,
#            "eval/R@1/t2i/english_lang": 58.1,
#            "eval/R@5/t2i/english_lang": 83.7,
#            "eval/R@10/t2i/english_lang": 92.5,
#            "eval/R@1/i2t/french_lang": 60.5,
#            "eval/R@5/i2t/french_lang": 85.3,
#            "eval/R@10/i2t/french_lang": 92.4,
#            "eval/R@1/t2i/french_lang": 55.7,
#            "eval/R@5/t2i/french_lang": 81.2,
#            "eval/R@10/t2i/french_lang": 90.1
#        }
#    },
#    {
#        "model_name": "Model_Y",
#        "json_data": {
#            "eval/R@1/i2t/english_lang": 68.4,
#            "eval/R@5/i2t/english_lang": 89.1,
#            "eval/R@10/i2t/english_lang": 95.2,
#            "eval/R@1/t2i/english_lang": 60.3,
#            "eval/R@5/t2i/english_lang": 85.9,
#            "eval/R@10/t2i/english_lang": 93.4
#        }
#    }
#]
#
...
for language in languages:
    ...
    ws.cell(row=1, column=col_start, value=language.capitalize()).alignment = Alignment(horizontal="center", vertical="center")
    
    ws.merge_cells(start_row=2, start_column=col_start, end_row=2, end_column=col_start + 2)
    ws.cell(row=2, column=col_start, value="I2T").alignment = Alignment(horizontal="center", vertical="center")
    
    ws.merge_cells(start_row=2, start_column=col_start + 3, end_row=2, end_column=col_start + 5)
    ws.cell(row=2, column=col_start + 3, value="T2I").alignment = Alignment(horizontal="center", vertical="center")
    
    ws.cell(row=3, column=col_start, value="R@1")
    ws.cell(row=3, column=col_start + 1, value="R@5")
    ws.cell(row=3, column=col_start + 2, value="R@10")
    ws.cell(row=3, column=col_start + 3, value="R@1")
    ws.cell(row=3, column=col_start + 4, value="R@5")
    ws.cell(row=3, column=col_start + 5, value="R@10")
    
    start_col += 6  # Move to the next language group

# Write model data rows
ws.cell(row=3, column=1, value="Model Name")
...
# Save the workbook
file_path = "./excels/recall_metrics_models.xlsx"
wb.save(file_path)
