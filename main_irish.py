...
if __name__ == "__main__":
    ...
    eng_file_paths = ["/home/piyush/labse-clip/irish-data/paracrawl_en_250000.txt"]
    non_eng_file_paths = ["/home/piyush/labse-clip/irish-data/paracrawl_ga_250000.txt"]
    ...
    train_data = TrainDataset(
        ...
        clip_text_to_id_path = f"./content/drive/MyDrive/base-clip-data/en-ga/{args.image_model}_text_to_id_train.pkl" ,
        labse_text_to_id_path = f"./content/drive/MyDrive/base-clip-data/en-ga/{args.text_model}_text_to_id_train.pkl",
    ...
    eval_data_path = "./irish-data/TEST/wit_ga_1000_downloaded.csv"
    img_text_df = pd.read_csv(eval_data_path)

    # below path is used to load and save text mappings
    text_to_id_path = "./content/drive/MyDrive/base-clip-data/en-ga/text_to_id.pkl"
    if args.text_model != "labse":
        text_to_id_path = f"./content/drive/MyDrive/base-clip-data/en-ga/{args.text_model}_text_to_id.pkl"
    ...
    eval_dataset = EmbeddingPrecomputator(
        ...
        #   'MIC_caption_fr'],
        lang_cols = ['caption_reference_description'],
        img_col = 'image_name',
